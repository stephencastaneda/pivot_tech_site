	...
	return (
		...
		<div className="pivot-card col-xs-6 ">
			...
			<div className="card-back">
					<img className="card-img-top" style={{ width:235, height:235 }} src={ props.execTeamMember.gif } stylealt="Gif" />
				</div>
      <div className="card card-front" style={{ width:235, height:235 }}>
				<img className="card-img-top team-photo" src={ props.execTeamMember.image } stylealt="Exec Team Member Photo" />
				</div>
