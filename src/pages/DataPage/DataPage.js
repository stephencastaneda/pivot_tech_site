...
function DataPage() {
  ...
  <div class="card-body data-page-card">
    <h1 className="data-page-title text-center text-white">Data Analytics</h1>
  </div>
  </div>

  <div class="card data-page-text-card mt-5">
  <div class="card-body data-text-card">
    <p>The technology boom of the last 20 years has generated more information than organizations know what to do with, and they need people to analyze the data and put it to use to make solid business decisions.</p>
    <p>The World Economic Forum listed data analyst as one of the most in-demand job categories across all industries in the U.S. as we enter the 2020s.</p>
    <p>If you are interested in data and analytics, there are exciting career possibilities to explore.</p>
    <p>Tuition: $6,500</p>
    <p>Deposit: $1,000</p>
...
<div className="courses-flex d-flex justify-content-around flex-wrap mt-5">
  ...
  <h5 class="card-header data-page-card-header">Module 1: Microsoft Excel &amp; Data Analysis Workflow</h5>
...
<div class="card data-page-course-card mb-5">
  <h5 class="card-header data-page-card-header">Module 2: Database Concepts &amp; SQL</h5>
  <div class="card-body data-page-course-card-text">
...
<div class="card data-page-course-card mb-5">
  <h5 class="card-header data-page-card-header">Module 3: Python &amp; Statistics</h5>
  <div class="card-body data-page-course-card-text">
...
<div class="card data-page-course-card mb-5">
  <h5 class="card-header data-page-card-header">Module 4: Data Visualization</h5>
  <div class="card-body data-page-course-card-text">
...
<div class="card data-page-course-card mb-5">
  <h5 class="card-header data-page-card-header">Module 5: Advanced Topics</h5>
  <div class="card-body data-page-course-card-text">
