...
function WebDevelopmentPage() {
  ...
  <div class="card-body web-development-card">
    <h1 className="web-development-title text-center text-white">Web Development</h1>
  </div>
  </div>

  <div class="card web-development-text-card mt-5">
  <div class="card-body web-text-card">
    <p>Employment of web developers is projected to grow 13 percent from 2018 to 2028, much faster than the average for all occupations. In addition, an increase in the use of mobile devices to search the web will lead to increased demand for web developers.</p>
    <p>Tuition: $6,500</p>
    <p>Deposit: $1,000</p>
...
<div className="courses-flex d-flex justify-content-around flex-wrap mt-5">
  ...
  <h5 class="card-header web-dev-card-header">Module 1: Introduction to Web Dev</h5>
...
<div class="card web-course-card mb-5">
  <h5 class="card-header web-dev-card-header">Module 2: Design Fundamentals</h5>
  <div class="card-body web-dev-course-card-text">
...
<div class="card web-course-card mb-5">
  <h5 class="card-header web-dev-card-header">Module 3: Javascript</h5>
  <div class="card-body web-dev-course-card-text">
...
<div class="card web-course-card mb-5">
  <h5 class="card-header web-dev-card-header">Module 4: Advanced Web Dev Concepts</h5>
  <div class="card-body web-dev-course-card-text">
...
<div class="card web-course-card mb-5">
  <h5 class="card-header web-dev-card-header">Module 5: Capstone Project</h5>
  <div class="card-body web-dev-course-card-text">
    <h5 class="card-title">Weeks 19-20</h5>
    <ul>
      <li>Students will create their own project using all of the skills learned in the previous weeks</li>
    </ul>
  </div>
</div>
</div>
