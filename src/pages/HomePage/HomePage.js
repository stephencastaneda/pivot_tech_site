				...
				<div class="mission-card-container">
					<div className="first-card card">
						<p className="bold-text">
							Many of the highest paying jobs in this country have a major lack
							of diversity amongst their ranks. This is especially true for the
							field of technology.
						</p>
						<p className="card-text">
							Technology has always had great influence on the advances in our
							society and that rings true even more today, considering tech has
							become so finely ingrained in our day-to-day activities.
						</p>
					</div>
					...
					<div className="third-card card">
						<p className="bold-text">
							Pivot Tech is here to provide a foundational and working knowledge
							of Software Development and Data Analytics to the underrepresented
							minorities in the tech field.
						</p>
						<p className="card-text">
							Our goal is to help as many people from this group as possible
							land their first tech jobs, which will help contribute to closing
							the wealth gap between races in America and simultaneously making
							companies more diverse and proportionate to the population they
							serve.
						</p>
					</div>
				</div>
